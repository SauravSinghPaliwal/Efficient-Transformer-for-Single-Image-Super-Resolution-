...
parser.add_argument("--root", type=str, default="/saurav",
...
testset = Set5_val.DatasetFromFolderVal("/saurav/dataset_decoded/DIV2K_valid_HR/",
                                       "/saurav/dataset_decoded/DIV2K_valid_LR_bicubic/X{}/".format(args.scale),
                                       args.scale)
